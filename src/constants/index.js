...
export const EXPERIENCES = [
  ...
  // },
  {
    ...
    description: `Developed predictive models to forecast restaurant ratings and built a recommendation system based on user preferences. I conducted geographical analysis and created interactive visualizations to uncover location-based insights. My work involved data preprocessing, feature engineering, and implementing content-based filtering to enhance user experience and decision-making.`,
