        ...
        <div className='flex flex-wrap lg:flex-row-reverse'>
            ...
            <div className='w-full lg:w-1/2'>
                <motion.div initial="hidden" animate="visiable" variants={containerVariants} className='flex flex-col items-center lg:items-start mt-10'>
                    ...
                    <motion.a variants={childVariants} href='https://drive.google.com/file/d/1wDpHKZCAoep4qCjttOSgJBz8T8w9NO3D/view?usp=sharing' target='_blank' rel='noopener noreferrer' download className='bg-white rounded-full p-4 text-sm text-stone-800 mb-10'>Download Resume</motion.a>
